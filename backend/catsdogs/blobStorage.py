...
service_client = BlobServiceClient.from_connection_string(os.environ["BLOB_STORAGE_CONNECTION_STRING"])
...
def get_blob_file_url_with_sas_token(file_url):
    ...
    parsed_connection_string = parse_connection_string(os.environ["BLOB_STORAGE_CONNECTION_STRING"])
